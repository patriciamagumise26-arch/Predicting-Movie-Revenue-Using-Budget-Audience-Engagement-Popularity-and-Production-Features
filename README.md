...
**Dataset:** [[(https://www.kaggle.com/datasets/tmdb/tmdb-movie-metadata)](https://www.kaggle.com/datasets/tmdb/tmdb-movie-metadata)) (Kaggle)  budget, popularity, vote average/count, runtime, language, genres, production companies/countries, release date, etc.
